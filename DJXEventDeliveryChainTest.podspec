#
#  Be sure to run `pod spec lint DJXEventDeliveryChainTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
 ...
 s.homepage     = "https://github.com/dongjianxiong/DJXEventDeliveryChainTest"
  ...
  # Or just: s.author    = "scad-build"
  # s.authors            = { "scad-build" => "scad-build@sohu-inc.com" }
  ...
  s.source       = { :git => "https://github.com/dongjianxiong/DJXEventDeliveryChainTest.git", :tag => "#{s.version}" }
  ...
  s.public_header_files = "Classes/ViewControllers/*.h"
